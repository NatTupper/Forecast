...
void screen_init() {
	...
	screen_load_texture_file(TEXTURE_TOP_SCREEN_BG, "romfs:/top_bg.png", true);
	screen_load_texture_file(TEXTURE_BOTTOM_SCREEN_BG, "romfs:/bot_bg.png", true);
	screen_load_texture_file(TEXTURE_CLOUD, "romfs:/cloud.png", true);
	screen_load_texture_file(TEXTURE_CLOUD_WITH_LIGHTNING, "romfs:/cloud_with_lightning.png", true);
	screen_load_texture_file(TEXTURE_CLOUD_WITH_LOTS_OF_RAIN, "romfs:/cloud_with_lots_of_rain.png", true);
	screen_load_texture_file(TEXTURE_CLOUD_WITH_RAIN, "romfs:/cloud_with_rain.png", true);
	screen_load_texture_file(TEXTURE_CLOUD_WITH_SNOW, "romfs:/cloud_with_snow.png", true);
	screen_load_texture_file(TEXTURE_CLOUD_WITH_SOME_RAIN, "romfs:/cloud_with_some_rain.png", true);
	screen_load_texture_file(TEXTURE_SUN, "romfs:/sun.png", true);
